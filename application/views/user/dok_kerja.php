                    ...
                    <table class=" table table-bordered table-hover" id="table-id" style="font_size:14px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url('user/file_download_dok_kerja/' . $dks['id']); ?>"
                                        class="btn btn-success btn-sm btn-block">Download</a></td>
                                <td> <a href="<?php echo base_url('user/edit_dok_kerja/' . $dks['id']); ?>"
                                        class="btn btn-info btn-sm btn-block">Detail</a></td>
                                <td><a href="<?php echo base_url('user/del_dok_kerja/' . $dks['id']); ?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Dokumen Siswa</h3>
            </div>
