    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="info-box bg-yellow">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Dokumen Lainnya</span>
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#activity" data-toggle="tab" style="font-weight:800;">Laporan Harian</a>
                </li>
                ...
                <li><a href="#dokkerja" data-toggle="tab" style="font-weight:800;">Dokumen Siswa</a></li>
                <li><a href="#dokpribadi" data-toggle="tab" style="font-weight:800;">Dokumen Lainnya</a></li>
