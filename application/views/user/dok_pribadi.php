                    ...
                    <table class=" table table-bordered table-hover" id="table-id" style="font_size:14px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url('user/file_download_dok_pribadi/' . $dps['id']); ?>"
                                        class="btn btn-success btn-sm btn-block">Download</a></td>
                                <td> <a href="<?php echo base_url('user/edit_dok_pribadi/' . $dps['id']); ?>"
                                        class="btn btn-info btn-sm btn-block">Detail</a></td>
                                <td><a href="<?php echo base_url('user/del_dok_pribadi/' . $dps['id']); ?>"
                                        class="tombol-delete btn btn-danger btn-sm btn-block">Hapus</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Dokumen Lainnya</h3>
            </div>
            ...
            <div class="modal-footer">
                <div class="pull-left text-muted">* Ekstensi File xls, xlsx, doc, docx, ppt, pptx, pdf, zip, rar</div>
                <br>
